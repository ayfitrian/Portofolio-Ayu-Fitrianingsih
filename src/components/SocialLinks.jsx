...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ayufitrianingsih/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@_ayfitriann",
    icon: Instagram,
    url: "https://www.instagram.com/_ayfitriann?igsh=MWRtaWtuYmV1dXlvYw==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@potabay",
    icon: Youtube,
    url: "https://www.youtube.com/@potabay",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@ayfitrian",
    icon: Github,
    url: "https://github.com/ayfitrian",
    color: "#ffffff",
