...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/ayfitrian",
      };
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Ayu Fitrianingsih</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Ayu Fitrianingsih — Full-Stack Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Ayu Fitrianingsih`}
        />
        <meta
